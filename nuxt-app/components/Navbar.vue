      ...
      <a href="/">
        ...
        <div class="flex gap-[14px] items-center">
          <a class="relative block" href="/cart">
            ...
            <span v-if="cartStore.cartCount > 0" class="absolute bg-red-700 text-white rounded-full w-[18px] h-[18px] flex items-center justify-center text-sm font-bold -top-2 -right-2">
              {{ cartStore.cartCount }}
            </span>
          </a>
          ...
          <template v-if="!authStore.isAuthenticated">
            <a class="capitalize hover:underline" href="/sign-in">sign in</a>
            <a class="capitalize hover:underline" href="/sign-up">sign up</a>
          </template>
